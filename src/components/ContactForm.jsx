...
export default function ContactForm({ variant = "light", className = "" }) {
  ...
  if (submitted) {
    return (
      <div className={cn("flex flex-col items-center justify-center text-center py-16 gap-5", className)}>
        ...
        <p className={cn("text-sm max-w-xs", variant === "dark" ? "text-gray-400" : "text-gray-500")}>
