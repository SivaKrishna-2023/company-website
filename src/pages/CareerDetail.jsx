          ...
          {submitted ? (
            <div className="flex flex-col items-center text-center py-10 gap-4">
              ...
              <p className="text-gray-500 text-sm max-w-xs">
                Thanks, <strong>{form.name}</strong>! Our team will review your
            ...
            <div className="lg:col-span-2 animate-slide-right">
              <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 sticky top-24">
                ...
                <p className="text-gray-500 text-sm mb-5">
                  Apply now and our team will reach out within 3–5 business
                  days.
                </p>
                <button
                  ...
                  style={{
                    ...
                    boxShadow: `0 8px 24px ${job.color}33`,
                  }}
                >
                  Apply for this Role →
                </button>
          ...
          >
            <div className="rounded-2xl p-6 border border-gray-100 bg-gray-50">
              ...
              <p className="text-gray-500 text-sm leading-relaxed mb-5">
                Innova Orbit Global Solutions LLP is a professional services
                company specializing in web development, digital marketing, and
                career support for IT professionals. We are a fast-growing,
                people-first team based in Hyderabad, India.
              </p>
